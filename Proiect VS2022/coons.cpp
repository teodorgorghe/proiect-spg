...
void coons::update_points()
{
	for(size_t i = 0; i < size_; i++)
	{
		...
		const float x = f0 * p1_[0] + f1 * p2_[0] + f2 * (t1_[0] - p1_[0]) + f3 * (t2_[0] - p2_[0]);
		const float y = f0 * p1_[1] + f1 * p2_[1] + f2 * (t1_[1] - p1_[1]) + f3 * (t2_[1] - p2_[1]);
		const float z = f0 * p1_[2] + f1 * p2_[2] + f2 * (t1_[2] - p1_[2]) + f3 * (t2_[2] - p2_[2]);
